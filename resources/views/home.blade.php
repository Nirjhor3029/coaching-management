                        ...
                        <div
                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <h3 class="text-slate-900 dark:text-white text-2xl font-bold">$124,500</h3>
                                </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <h3 class="text-slate-900 dark:text-white text-2xl font-bold">$84,000</h3>
                                </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <h3 class="text-slate-900 dark:text-white text-2xl font-bold">$32,000</h3>
                                </div>
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex flex-col gap-1">
                                    ...
                                    <h3 class="text-slate-900 dark:text-white text-2xl font-bold">$52,000</h3>
                                </div>
                                <div class="p-2 bg-green-500/10 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-slate-600 dark:text-[#9da6b9] text-sm">5 Students have overdue payments
                                        &gt; 30 days.</p>
                                </div>
                                <button
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-slate-600 dark:text-[#9da6b9] text-sm">3 Teachers pending payment for
                                        October.</p>
                                </div>
                                <button
                        ...
                        <div
                            ...
                            <div class="w-full h-64 flex items-end gap-4 pt-8 relative">
                                ...
                                <div class="absolute inset-0 flex flex-col justify-between pointer-events-none pb-8">
                                    <div
                                        class="w-full h-px border-t border-dashed border-slate-200 dark:border-gray-700/50">
                                    </div>
                                    <div
                                        class="w-full h-px border-t border-dashed border-slate-200 dark:border-gray-700/50">
                                    </div>
                                    ...
                                    <div class="w-full h-px bg-slate-200 dark:bg-[#282e39]"></div>
                                </div>
                                ...
                                <svg class="absolute inset-0 w-full h-full pointer-events-none pb-8 pl-4 pr-4"
                                    ...
                                    <path d="M0,180 L80,140 L160,190 L240,100 L320,130 L400,60" fill="none" stroke="#fbbf24"
                                        stroke-dasharray="4 4" stroke-width="2"></path>
                                </svg>
                            </div>
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr
                                        ...
                                        <th
                                            class="p-4 font-medium border-b border-slate-200 dark:border-slate-700 text-right">
                                            Actions</th>
                                    </tr>
                                </thead>
                                <tbody
