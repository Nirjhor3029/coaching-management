...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-subjectTeachers">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($teachers as $key => $teacher)
                        <tr data-entry-id="{{ $teacher->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $teacher->status ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-subjectTeachers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
