    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shifts.update", [$shift->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shift_code') ? 'is-invalid' : '' }}" type="text" name="shift_code" id="shift_code" value="{{ old('shift_code', $shift->shift_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shift_time') ? 'is-invalid' : '' }}" type="text" name="shift_time" id="shift_time" value="{{ old('shift_time', $shift->shift_time) }}">
