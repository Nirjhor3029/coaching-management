...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.academicClass.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.academic-classes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('academic_year') ? 'is-invalid' : '' }}" type="text" name="academic_year" id="academic_year" value="{{ old('academic_year') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('class_code') ? 'is-invalid' : '' }}" type="text" name="class_code" id="class_code" value="{{ old('class_code', '') }}">
